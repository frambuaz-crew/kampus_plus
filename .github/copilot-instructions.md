# kampus_plus Development Guidelines
...
- ✅ Phase 1: Design complete (data model, API contracts, quickstart)
- ✅ Phase 2: Task breakdown complete (217 tasks with TDD approach)
- ⏭️ Next: Begin Phase 1 tasks (T001-T020: Project Setup & Infrastructure)

## Key Reminders
- **TDD Mandate**: Write tests FIRST (Red), verify fail, then implement (Green)
- **Constitution**: Security by default, AI ethics (anonymization), no prompt logs
- **MVP Scope**: US1 (Auth) + US2 (AI Chat) = 60 tasks, 4-6 weeks
