...
class CourseSchedule(Base):
    ...
    schedule_data: Mapped[str] = mapped_column(DialectJSON, nullable=False)  # JSON object
...
class AcademicContribution(Base):
    ...
    manual_data: Mapped[Optional[str]] = mapped_column(DialectJSON, nullable=True)  # JSON object
