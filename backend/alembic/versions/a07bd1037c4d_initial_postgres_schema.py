...
Revision ID: a07bd1037c4d
Revises: 
Create Date: 2026-04-24 17:03:37.132627
"""
...
def upgrade() -> None:
    ...
    sa.Column('yok_data', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('is_active', sa.Boolean(), server_default=sa.text('true'), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    ...
    op.create_index(op.f('ix_academic_calendar_events_is_approved'), 'academic_calendar_events', ['is_approved'], unique=False)
    op.create_index(op.f('ix_academic_calendar_events_university_id'), 'academic_calendar_events', ['university_id'], unique=False)
    ...
    op.create_index(op.f('ix_course_note_topics_course_code'), 'course_note_topics', ['course_code'], unique=False)
    op.create_index(op.f('ix_course_note_topics_university_id'), 'course_note_topics', ['university_id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['university_id'], ['universities.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('university_id', 'department', 'class_year', 'semester', 'academic_year', name='uq_course_schedules_unique')
    )
    op.create_index(op.f('ix_course_schedules_department'), 'course_schedules', ['department'], unique=False)
    op.create_index(op.f('ix_course_schedules_is_approved'), 'course_schedules', ['is_approved'], unique=False)
    op.create_index(op.f('ix_course_schedules_university_id'), 'course_schedules', ['university_id'], unique=False)
    ...
    sa.Column('topic_type', sa.String(length=20), server_default=sa.text("'text'"), nullable=False),
    ...
    op.create_index(op.f('ix_course_note_entries_topic_id'), 'course_note_entries', ['topic_id'], unique=False)
    ...
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.ForeignKeyConstraint(['author_id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['parent_id'], ['forum_replies.id'], ondelete='CASCADE'),
    ...
    op.create_index(op.f('ix_course_note_attachments_entry_id'), 'course_note_attachments', ['entry_id'], unique=False)
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_course_note_attachments_entry_id'), table_name='course_note_attachments')
    ...
    op.drop_index(op.f('ix_course_note_entries_topic_id'), table_name='course_note_entries')
    ...
    op.drop_index(op.f('ix_course_schedules_university_id'), table_name='course_schedules')
    op.drop_index(op.f('ix_course_schedules_is_approved'), table_name='course_schedules')
    op.drop_index(op.f('ix_course_schedules_department'), table_name='course_schedules')
    op.drop_table('course_schedules')
    op.drop_index(op.f('ix_course_note_topics_university_id'), table_name='course_note_topics')
    op.drop_index(op.f('ix_course_note_topics_course_code'), table_name='course_note_topics')
    ...
    op.drop_index(op.f('ix_academic_calendar_events_university_id'), table_name='academic_calendar_events')
    op.drop_index(op.f('ix_academic_calendar_events_is_approved'), table_name='academic_calendar_events')
